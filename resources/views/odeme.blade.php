                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="adsoyad"
                                           value="{{auth()->user()->adsoyad}}" id="adsoyad" required>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="adres"
                                           value="{{$kullanici_detay->adres}}" id="adres" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control telefon" name="telefon"
                                           value="{{$kullanici_detay->telefon}}" id="telefon"
                                           required>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control telefon" name="ceptelefonu"
                                           value="{{$kullanici_detay->ceptelefonu}}" id="ceptelefonu"
                                           required>
                                </div>
                            </div>
                        </div>
